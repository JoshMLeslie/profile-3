...
},
{
	...
	skills: 'React, Redux, Bootstrap, Saga, Storybook, Jasmine, Jest, AWS, JIRA',
	type: 'F'
},
{
	header: {
	...
	skills: 'Angular, TypeScript, Material UI, Bootstrap, Storybook, GCloud, JIRA',
	type: 'F'
},
{
	header: {
...
},
{
	...
	skills: 'Angular, TypeScript, Bootstrap, Material UI, jQuery, InVision, JIRA',
	type: 'C'
},
{
	header: {
	...
	skills: 'Angular, TypeScript, Bootstrap, jQuery, Jasmine, Jest, ShallowRender, JIRA',
	type: 'C'
},
{
	header: {
...
},
{
	...
	skills: 'Member Management, Team Management, Woodworking, Metalworking, CAD/CAM',
	type: 'V'
}
...
const generateJobDataHTML = (data) => {
	const parentDiv = document.getElementById('job-history'); // Replace 'parentDiv' with the ID of your shared parent <div>
	...
	data.forEach(child => {
			...
			child.about.forEach(text => {
					...
					([_, firstWord.textContent, bodyText.textContent] = text.match(/(\w+)\s(.*)/)); // this feels illegal
